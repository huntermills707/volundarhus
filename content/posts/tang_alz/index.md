...
All models were evaluated on *300 bootstrap* replicates of the held-out set (1,000 patients per replicate), giving AUROC/AUPRC distributions rather than point estimates.
...
All of these were identified *without any laboratory biomarkers*, which says a lot about how much signal sits in routine EHR data.
...
These connections suggest mechanistic hypotheses. The repeated appearance of *APOE* and *IL6*, for instance, links hyperlipidemia, osteoporosis, and AD, which lines up with prior work on lipid metabolism and inflammation in neurodegeneration.
...
The net result is a pragmatic path from real-world clinical data to a predictive model to testable biological hypotheses.

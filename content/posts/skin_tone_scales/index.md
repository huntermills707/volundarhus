...
## Introduction
Fairness assessments for medical AI, especially devices like pulse oximeters and dermatology classifiers, often rely on subjective skin-tone scales such as Fitzpatrick and Monk. Our recent prospective study, published in npj Digital Medicine (2025), shows these scales are far from reliable. Below I walk through the study and what it means for anyone building or auditing healthcare AI systems.
...
## Closing Thoughts
Subjective skin-tone scales, despite their ubiquity, should not be the sole fairness metric for medical AI. Their moderate inter-rater reliability and the systematic gap with patient self-reports can mask real disparities or manufacture ones that aren't there. Multiple diverse annotators, objective pigment measurement, and honest uncertainty reporting would go a long way.

...
Our recent paper in JAMA Network Open, a joint effort between the Mass General Brigham (MGB) network and the University of California (UC) health system, provides the most comprehensive look yet at the long-term health trajectory of people living with TSCI. By linking two massive electronic-health-record databases spanning nearly three decades (1996-2024), we examined more than 2,700 TSCI patients and over 8,200 matched, uninjured controls. The goal was to answer a simple question: does surviving a spinal cord injury predispose someone to chronic diseases later in life?
...
4. **Educate Patients and Families:** Making patients aware of these hidden risks helps them seek preventive care earlier and adopt healthier lifestyles (e.g., structured exercise programs adapted for mobility limitations).

## Limitations & Future Directions

Our study relied on ICD-9/10 coding, which, while generally reliable, can miss nuances such as disease severity. We also lacked granular data on injury severity scores, rehabilitation intensity, and socioeconomic factors, all of which could modulate risk. Future work should explore causal pathways (e.g., mediation analysis) and test interventions, possibly using wearable technology or digital health platforms, to mitigate these downstream effects.

## Closing Thoughts

Surviving a spinal cord injury is not the end of the story. It is the start of a chronic health journey spanning cardiovascular, neurologic, psychiatric, and endocrine domains. Treating TSCI as a systemic condition, with surveillance to match, should let clinicians shift from reactive to proactive care and improve both longevity and quality of life for this population.

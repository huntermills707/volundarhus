...
* **Performance:** All three models achieved strong discrimination. The full model was best, dropping PFTs barely hurt AUC, and removing NLP reduced performance noticeably.
...
* **Feasibility:** Even for a rare, heterogeneous condition, supervised ML can reach >0.9 AUC using routinely collected EHR data.
* **Utility of unstructured text:** Clinical notes add substantial signal beyond codes and labs, which is a good argument for NLP pipelines in health-record mining.
* **Scalability:** An EHR-agnostic version of the model could be deployed across institutions to automate cohort assembly for ILD studies and clinical trials, and potentially for sub-phenotype identification (e.g., idiopathic pulmonary fibrosis).
...
This is a concrete recipe for building interpretable, high-performing cohort-identification models in rare diseases:

1. **Combine structured and unstructured EHR streams:** that combination gives the biggest boost.

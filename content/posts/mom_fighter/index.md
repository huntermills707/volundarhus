...
description = "A qualitative analysis of combat metaphors in over 200,000 ICU notes. Nearly 6,000 validated metaphors fell into identity frames (patient as fighter) and process frames (fighting the ventilator). While often well-intentioned, these metaphors can disempower families, justify invasive interventions, and obscure prognostic realities. Also covers how NLP lexicons built from FrameNet can support bias detection, sentiment analysis, and real-time documentation alerts in clinical text pipelines."
slug = ""
...
You might wonder why a paper on linguistic flair in intensive-care notes shows up on a site that usually talks algorithms and model pipelines. Fair question. The answer is that data is data, whether it's a pixel map or a paragraph of clinical prose. Turning thousands of free-text notes into structured variables is the same signal-extraction problem as any other ML work, and here the patterns have real consequences for patient care.

## The Core Finding in Plain English
We scanned over 200k ICU notes from a major academic health system, looking for any word that belongs to a “combat” frame (think fight, battle, struggle, bout). After cleaning and human validation, nearly 6,000 genuine metaphors survived. They fell into two buckets:
...
## Takeaway
Combat metaphors are everywhere in ICU notes, and they cut both ways. They can inspire, but they can also mislead patients, families, and clinicians. If you’re building tools that ingest clinical text, treat these metaphors as signal, not fluff. They carry real implications for care pathways and ethical decision-making.

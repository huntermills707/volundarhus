...
Traumatic brain injury (TBI) is a leading cause of disability worldwide, yet its long-term oncologic sequelae remain poorly understood. A 2024 veteran-population study suggested a link between severe TBI and brain cancer, but civilian data have been contradictory. Our multicenter retrospective cohort, spanning three major U.S. academic health systems, is the largest civilian evidence to date: moderate-to-severe TBI was associated with a roughly 50% higher risk of developing a malignant brain tumor.
...
* **Severity matters.** Only moderate-to-severe injuries, not mild concussions, showed a statistically significant increase in tumor risk.
...
* **Public-health implication.** While absolute risk stays low (<1%), the relative increase suggests clinicians might consider longer-term neuro-oncologic surveillance for patients with severe TBI, especially when other risk factors (e.g., ionizing radiation exposure) coexist.
